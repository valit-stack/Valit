...
{
    public class UInt32_IsEqualTo_Tests
    {
        [Fact]
        public void UInt32_IsEqualTo_For_Not_Nullable_Values_Throws_When_Null_Rule_Is_Given()
        {
        ...
        [Fact]
        public void UInt32_IsEqualTo_For_Not_Nullable_Value_And_Nullable_Value_Throws_When_Null_Rule_Is_Given()
        {
            var exception = Record.Exception(() => {
                ((IValitRule<Model, uint>)null)
                    .IsEqualTo((uint?)1);
        ...
        [Fact]
        public void UInt32_IsEqualTo_For_Nullable_Value_And_Not_Nullable_Value_Throws_When_Null_Rule_Is_Given()
        {
            var exception = Record.Exception(() => {
                ((IValitRule<Model, uint?>)null)
                    .IsEqualTo(1);
        ...
        [Fact]
        public void UInt32_IsEqualTo_For_Nullable_Values_Throws_When_Null_Rule_Is_Given()
        {
            var exception = Record.Exception(() => {
                ((IValitRule<Model, uint?>)null)
                    .IsEqualTo((uint?)1);
