...
namespace Valit.Tests.UInt32
{
    public class UInt32_IsLessThan_Tests
    {
        ...
        [Fact]
        public void UInt32_IsLessThan_For_Not_Nullable_Value_And_Nullable_Value_Throws_When_Null_Rule_Is_Given()
        {
            var exception = Record.Exception(() => {
                ((IValitRule<Model, uint>)null)
                    .IsLessThan((uint?)1);
        ...
        [Fact]
        public void UInt32_IsLessThan_For_Nullable_Value_And_Not_Nullable_Value_Throws_When_Null_Rule_Is_Given()
        {
            var exception = Record.Exception(() => {
                ((IValitRule<Model, uint?>)null)
                    .IsLessThan(1);
        ...
        [Fact]
        public void UInt32_IsLessThan_For_Nullable_Values_Throws_When_Null_Rule_Is_Given()
        {
            var exception = Record.Exception(() => {
                ((IValitRule<Model, uint?>)null)
                    .IsLessThan((uint?)1);
...
#region ARRANGE
        public UInt32_IsLessThan_Tests()
        {
            _model = new Model();
        }
