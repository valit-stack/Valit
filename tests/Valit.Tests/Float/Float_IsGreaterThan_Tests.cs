...
namespace Valit.Tests.Float
{
    public class Float_IsGreaterThan_Tests
    {
        ...
        public void Int16_IsGreaterThan_Returns_Proper_Results_For_Not_Nullable_Values(float value, bool expected)
        {
        ...
        public void Int16_IsGreaterThan_Returns_Proper_Results_For_Not_Nullable_Value_And_Nullable_Value(float? value, bool expected)
        {
            IValitResult result = ValitRules<Model>
                .Create()
                .Ensure(m => m.Value, _ => _
        ...
        public void Int16_IsGreaterThan_Returns_Proper_Results_For_Nullable_Value_And_Not_Nullable_Value(bool useNullValue, float value, bool expected)
        {
            IValitResult result = ValitRules<Model>
                .Create()
        ...
        public void Int16_IsGreaterThan_Returns_Proper_Results_For_Nullable_Values(bool useNullValue, float? value, bool expected)
        {
            IValitResult result = ValitRules<Model>
                .Create()
                .Ensure(m => useNullValue ? m.NullValue : m.NullableValue, _ => _
